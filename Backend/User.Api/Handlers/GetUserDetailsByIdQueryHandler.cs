...
{
    public class GetUserDetailsByIdQueryHandler : IRequestHandler<GetUserDetailsByIdQuery, User>
    {
        ...
        public async Task<User> Handle(GetUserDetailsByIdQuery request, CancellationToken cancellationToken)
        {
